...
define(function(require, exports, module) {
    ...
    exports['test .toString()'] = function(assert, util) {
        assert.equal((new SourceNode(null, null, null, ['function foo() {',
    ...
    exports['test .replaceRight'] = function(assert, util) {
        ...
        // Nested
        node = new SourceNode(null, null, null, [new SourceNode(null, null, null, 'hey sexy mama, '),
    ...
    exports['test .toStringWithSourceMap()'] = forEachNewline(function(assert, util, nl) {
        var node = new SourceNode(null, null, null, ['(function () {' + nl,
            '  ',
